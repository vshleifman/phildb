...
export const periodData: PeriodDataType[] = [
  ...
  },
  {
    ...
    era: "Medieval",
    text1: "The Medieval period of philosophy represents a renewed flowering of Western philosophical thought after the intellectual drought of the Dark Ages.",
    text2: "Much of the period is marked by the influence of Christianity and many of the philosophers of the period were greatly concerned with proving the existence of God and reconciling Christianity with classical philosophy. The early Christian theologians St. Augustine and Boethius represent a link between the Roman and Medieval periods, and arguably had more in common with the later Medieval philosophers than with the earlier Romans (where they have been included for the purposes of this guide).",
    text3: "An important development in the Medieval period was the establishment of the first universities with professional full-time scholars. It should also be noted that there was also a strong resurgence in Islamic and Jewish philosophy at this time.",
    text4: "The most influential movements of the period were Scholasticism and its off-shoots Thomism and Scotism, and the Islamic schools of Averroism, Avicennism and Illuminationism.",
